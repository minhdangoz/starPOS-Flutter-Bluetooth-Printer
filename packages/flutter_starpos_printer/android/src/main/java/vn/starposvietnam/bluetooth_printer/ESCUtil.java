...
public class ESCUtil {
	...
	/**
	 */
	public static byte[] getPrintZXingQRCode(String data, int size) {
	...
	public static byte[] selectBitmap(Bitmap bitmap, int mode) {
		...
		return BytesUtil.byteMerger(
				BytesUtil.byteMerger(new byte[] { ESC, 0x33, 0x00 }, BytesUtil.getBytesFromBitMap(bitmap, mode)),
